...
def generate_password_and_show(length_entry, complexity_var):
    try:
        ...
        if password:
            password_label.config(text=f"Generated Password: {password}",bg='brown',fg='white',font=('CourierNewBaltic',16))
...
tk.Label(complexity_frame, text="Choose Password Complexity").pack()
